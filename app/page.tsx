...
export default function Home() {
  return (
    <main>
      ...
      <section className="contact" id="contact"><div className="shell contact-grid"><div><p className="eyebrow">START A CONVERSATION</p><h2>What are you<br/>sourcing next?</h2><p>Tell us whether you need ready stock, a mixed container or a custom ceramic collection. Our team will reply with the right next step.</p><div className="contact-pills"><span>Ready stock</span><span>Mixed container</span><span>OEM/ODM</span></div><address><span>WhatsApp</span><a href="https://wa.me/8615280186517" target="_blank" rel="noreferrer">+86 152 8018 6517</a><span>Email</span><a href="mailto:sales@jozing.cn">sales@jozing.cn</a><span>Address</span><p>No. 3, Gubantou Village, Chao&apos;an District, Chaozhou, Guangdong, China</p></address></div><form><label>Your work email<input type="email" placeholder="name@company.com" /></label><div className="form-row"><label>Country / market<input type="text" placeholder="e.g. UAE" /></label><label>Purchase type<select defaultValue=""><option value="" disabled>Select one</option><option>Ready stock</option><option>OEM / ODM</option><option>Both</option></select></label></div><label>What are you looking for?<textarea placeholder="Product, quantity, target price and destination port..." rows={4}/></label><a className="submit-link" href="https://wa.me/8615280186517?text=Hello%20JOZING%2C%20I%20would%20like%20to%20request%20a%20ceramic%20tableware%20quotation." target="_blank" rel="noreferrer">Send inquiry on WhatsApp <span>↗</span></a><a className="email-link" href="mailto:sales@jozing.cn?subject=Ceramic%20Tableware%20Inquiry">Or email sales@jozing.cn</a><small>Please include the product, quantity, target price and destination port.</small></form></div></section>

      <footer><div className="shell footer-grid"><a className="brand-logo footer-logo" href="#top" aria-label="JOZING home"><img src="/jozing-logo-fresh.png" alt="JOZING" width="567" height="158" /></a><p>Flexible ceramic tableware supply<br/>for global B2B buyers.</p><div><a href="#stock">Ready Stock</a><a href="#oem">OEM/ODM</a><a href="#factory">Capability</a><a href="https://wa.me/8615280186517" target="_blank" rel="noreferrer">WhatsApp</a><a href="mailto:sales@jozing.cn">Email</a><a href="#contact">Contact</a></div></div><div className="shell copyright"><span>© 2026 JOZING Ceramics. All rights reserved.</span><span>No. 3, Gubantou Village, Chao&apos;an District, Chaozhou, Guangdong, China</span></div></footer>
