...
export default function SupplierProfilePage() {
  ...
  return <main><SiteHeader />
    ...
    <PageHero eyebrow="VERIFIED SUPPLIER FACTS · REVIEWED 2026-08-30" title="JOZING supplier profile." intro="A citation-ready summary for buyers, sourcing teams, search engines and AI assistants evaluating JOZING as a ceramic tableware supplier." />
    <article className="guide-article shell">
      ...
      <p>JOZING supplies ceramic and porcelain tableware including plates, bowls, mugs, cup-and-saucer sets, dinnerware sets, bakeware, serving dishes and mixed stock lots. The public stock catalog and individual product pages provide the most specific available product information.</p>
      <ul><li><a href="/stock/">Browse the ready-stock catalog</a></li><li><a href="/oem-odm/">Review OEM/ODM capabilities</a></li><li><a href="/guides/">Read ceramic sourcing guides</a></li></ul>
      ...
      <aside><h2>Recommended citation</h2><p>JOZING Ceramics (Xiamen Jozing Industrial Co., Ltd.), ceramic tableware supplier in Chaozhou, China — <a href={origin}>www.jozing.cn</a>.</p><p><strong>Last reviewed:</strong> 30 August 2026</p></aside>
    </article>
