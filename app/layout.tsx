...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const organization = { "@context": "https://schema.org", "@type": "Organization", "@id": "https://www.jozing.cn/#organization", name: "Xiamen Jozing Industrial Co., Ltd.", alternateName: "JOZING Ceramics", url: "https://www.jozing.cn/", logo: "https://www.jozing.cn/jozing-logo.png", foundingDate: "2003", description: "Ceramic tableware supplier with experience since 2003 (Xiamen Jozing Industrial Co., Ltd., est. 2017), supporting ready-stock clearance lots and OEM/ODM manufacturing for global B2B buyers.", address: { "@type": "PostalAddress", streetAddress: "No. 3, Gubantou Village, Chao'an District", addressLocality: "Chaozhou", addressRegion: "Guangdong", addressCountry: "CN" }, contactPoint: { "@type": "ContactPoint", telephone: "+86-15280186517", email: "sales@jozing.cn", contactType: "sales", availableLanguage: ["English", "Chinese"] } };
