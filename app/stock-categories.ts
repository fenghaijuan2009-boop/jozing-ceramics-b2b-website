...
export const stockCategories = [
  ...
  { slug: "hot-sale-by-ton-carton", name: "Hot Sale By Ton & Carton", codes: ["JZ-A11000037703372", "JZ-A1601674765483", ...[11,13,14,15,16,22,23,24].map(n => `STOCK · ${n}`)] },
  { slug: "dinner-set-tableware", name: "Dinner Set & Tableware", codes: ["JZ-A11000036948656", "JZ-A11000037703372", "JZ-A1601674765483", "2026071501", "2026082901", ...[1,3,6,14,15,18,19,20,21,22,23,24].map(n => `STOCK · ${String(n).padStart(2,"0")}`)] },
