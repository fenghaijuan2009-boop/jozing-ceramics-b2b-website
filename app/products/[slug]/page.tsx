...
export default async function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const productSchema = { "@context": "https://schema.org", "@type": "Product", name: product.name, sku: product.code, image: images.map((image) => `${origin}${image}`), description: product.type, material: product.material, color: product.colors, size: product.capacity, brand: { "@type": "Brand", name: "JOZING" }, manufacturer: { "@type": "Organization", name: "Xiamen Jozing Industrial Co., Ltd.", url: origin }, offers: offers.length ? offers : { "@type": "Offer", priceCurrency: "USD", availability: "https://schema.org/InStock", url } };
